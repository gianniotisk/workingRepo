...
import irishmanPoster from "../assets/Pictures/irishmanPoster.png";
import irishmanPoster_2 from "../assets/Pictures/irishmanPoster_2.png";

import birdsPoster from "../assets/Pictures/birdsPoster.png";
import birdsPoster_2 from "../assets/Pictures/birdsPoster_2.png";

import sleepPoster from "../assets/Pictures/sleepPoster.png";
import sleepPoster_2 from "../assets/Pictures/sleepPoster_2.png";

import zombielandPoster from "../assets/Pictures/zombielandPoster.png";
import zombielandPoster_2 from "../assets/Pictures/zombielandPoster_2.png";
...
const PostData = [
    ...
    // ============================================== FEATURED ARTICLES =====
    {
        ...
        content: [
            ...
            { type: "text", value: "What makes Joker stand out is its raw, unpredictable nature. Every scene is carefully constructed to heighten the tension, making the audience feel as though they are spiraling into madness alongside Fleck. The film’s cinematography and score further elevate the atmosphere, creating a deeply unsettling yet mesmerizing experience. The infamous 'staircase dance' scene became an instantly iconic moment in cinema, symbolizing Arthur's full transformation into the Joker. If you haven't rewatched this masterpiece recently, now is the perfect time to revisit Gotham's twisted reality and understand why this movie remains one of the best of its era." }
        ]
    },
    {
        id: "2",
        ...
        content: [
            ...
            { type: "text", value: "One of the film’s greatest strengths is its realistic portrayal of racing. Every car chase and high-speed moment is shot with breathtaking intensity, making the audience feel every gear shift and tire screech. The chemistry between Damon and Bale is another highlight, showcasing the deep friendship and respect between Shelby and Miles despite the challenges they faced. Even if you’re not a fan of racing, Ford v Ferrari delivers a compelling story of ambition and the drive to achieve greatness." }
        ]
    },
    {
        id: "3",
        ...
        content: [
            { type: "text", value: "1917 is more than a war movie—it’s an immersive journey through the trenches of World War I, captured in a stunning single-shot illusion that keeps audiences on edge. Director Sam Mendes and cinematographer Roger Deakins crafted a unique viewing experience where the entire film feels like one continuous take, adding to the intensity and realism of the story. The film follows two young British soldiers, played by George MacKay and Dean-Charles Chapman, as they race against time to deliver a critical message that could save thousands of lives." },
            { type: "image", value: nineteenPoster_2, caption: "A behind-the-scenes look at how the incredible long-shot sequences were achieved." },
            { type: "text", value: "The film’s cinematography is groundbreaking, creating a sense of real-time urgency that immerses the viewer directly into the chaos of war. Every trench, every explosion, and every narrow escape is captured with such precision that it feels as though the audience is right alongside the soldiers. The emotional weight of the film is equally powerful—1917 is not just about war, but about brotherhood, survival, and the sacrifices made in the name of duty. Whether you’re a history buff or simply a fan of masterful storytelling, this is a must-watch." }
        ]
    },
    {
        id: "4",
        ...
        content: [
            { type: "text", value: "Knives Out is a modern murder mystery that keeps you guessing till the very end. With a brilliant script by Rian Johnson and an incredible cast featuring Daniel Craig, Ana de Armas, Chris Evans, and Jamie Lee Curtis, the film pays homage to classic whodunits while adding a fresh, humorous twist. The story follows the mysterious death of a wealthy crime novelist, with every member of his eccentric family becoming a suspect." },
            { type: "image", value: knivesPoster_2, caption: "The dysfunctional Thrombey family—full of secrets, lies, and betrayal." },
            { type: "text", value: "What makes Knives Out truly special is its razor-sharp dialogue and intricate plot, which keeps audiences engaged as new revelations unfold. Daniel Craig’s performance as the quirky detective Benoit Blanc is one of the film’s highlights, bringing both comedy and intelligence to the investigation. The film's attention to detail and clever misdirection make it a joy to rewatch, as hidden clues become more apparent each time. If you love suspense, humor, and clever storytelling, this is one movie you cannot miss." }
        ]
    },
    {
        id: "5",
        ...
        content: [
            { type: "text", value: "The Lighthouse is a hauntingly beautiful yet deeply unsettling film that explores themes of madness, isolation, and the human psyche. Directed by Robert Eggers, this psychological thriller follows two lighthouse keepers, played by Robert Pattinson and Willem Dafoe, as they descend into madness while stationed on a remote island. Shot entirely in black and white, the film pays homage to early cinema, creating a sense of claustrophobia and unease that lingers throughout. The film’s unique 4:3 aspect ratio further enhances the feeling of entrapment, making the audience feel as confined as the characters themselves." },
            { type: "image", value: lighthousePoster_2, caption: "Pattinson and Dafoe deliver performances filled with raw intensity and paranoia." },
            { type: "text", value: "Beyond its striking cinematography, The Lighthouse thrives on its powerhouse performances. Willem Dafoe’s portrayal of the seasoned, superstitious keeper is both mesmerizing and terrifying, while Pattinson delivers one of his most complex performances to date. The film draws inspiration from maritime folklore, psychological horror, and even Lovecraftian horror, making it an experience that demands multiple viewings. Its ambiguous ending and symbolic storytelling have left audiences debating its meaning for years. Whether it’s a deep dive into psychological torment or a supernatural nightmare, one thing is clear—The Lighthouse is an unforgettable cinematic experience that will stay with you long after the credits roll." }
        ]
    },
    {
        id: "6",
        ...
        content: [
            ...
            { type: "text", value: "Beyond its nostalgic appeal, the film also reimagines the tragic events surrounding the Manson Family murders, offering a fictionalized version of history where things take an unexpected turn. Brad Pitt’s Cliff Booth is one of Tarantino’s most charismatic characters, with his effortless coolness and quiet strength making him a standout. Meanwhile, DiCaprio delivers one of his most layered performances as an actor struggling with his own relevance. With its slow-burn pacing and shocking finale, Once Upon a Time in Hollywood is both a love letter to old Hollywood and a gripping piece of alternative history that only Tarantino could pull off. Whether you’re a die-hard fan of classic cinema or just love a great story, this is a film that deserves a spot on your must-watch list." }
        ]
    },    
    ...
    // ================================================================== NEWS ARTICLES =====
    {
        ...
        content: [
            ...
            { type: "text", value: "Insiders close to the production have hinted that the film will feature some of the most ambitious car stunts ever attempted. One sequence reportedly involves a high-speed chase that defies the laws of physics, possibly involving vehicles performing maneuvers in zero gravity. Fans have long joked that the franchise would eventually send Dom and his crew to space, and based on recent leaks, this joke might not be far from reality. With John Cena joining the cast as Dom’s long-lost brother and the return of fan-favorite characters, Fast & Furious 9 promises to deliver the high-adrenaline spectacle the franchise is known for." }
        ]
    },
    {
        id: "8",
        ...
        content: [
            ...
            { type: "text", value: "Though details remain scarce, insiders claim that Scorsese has been in early discussions with Robert De Niro and Al Pacino about a new project focusing on the rise of crime syndicates in the 1980s. Some reports suggest that the new film could take inspiration from real-life mob families and explore their struggles in a rapidly changing world dominated by politics, law enforcement crackdowns, and financial fraud. Whether this turns out to be a continuation of The Irishman’s themes or something entirely new, one thing is certain—if Scorsese is behind it, fans can expect a masterful take on crime cinema." }
        ]
    },
    {
        id: "9",
        ...
        content: [
            ...
            { type: "text", value: "Despite its financial struggles, Birds of Prey has since developed a strong cult following. Fans have praised its bold direction, energetic fight sequences, and unique approach to the superhero genre. With Warner Bros. focusing on expanding the DC Extended Universe, rumors suggest that Robbie’s Harley Quinn may return in future projects—possibly in a Gotham City Sirens film or another team-up with Poison Ivy. While a direct Birds of Prey sequel remains uncertain, Yan remains optimistic about the film’s legacy and the growing appreciation it has gained in recent years." }
        ]
    },
    {
        id: "10",
        ...
        content: [
            ...
            { type: "text", value: "Flanagan ultimately decided to scale back these appearances, choosing to focus on Ewan McGregor’s Danny Torrance and the new characters introduced in Stephen King’s novel. However, he remains open to revisiting the Overlook Hotel in future projects, possibly through a prequel or spin-off exploring its dark history." }
        ]
    },
    {
        id: "11",
        ...
        content: [
            ...
            { type: "text", value: "Some rumored plotlines suggest a crossover with new survivors from a different region, introducing a larger variety of zombies and even a potential new villain. Woody Harrelson, Jesse Eisenberg, and Emma Stone have all expressed interest in returning, provided the script is strong enough. While nothing has been officially confirmed, Reese and Wernick believe the franchise still has room to grow and hope to bring another installment to life in the coming years." }
        ]
    },
    {
        id: "12",
