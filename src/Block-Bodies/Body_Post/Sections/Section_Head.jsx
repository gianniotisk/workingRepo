...
export default function Section_Head({ title, image, meta = {}, tags, id, movieTitle }) {
  return (
    <div className={styles.headSection}>
      <div className={styles.container}>
        ...
        {/*---------------- Right: Bookmark & Tags ----------------*/}
        <Unit_Linkage title={title} image={image} meta={meta} tags={tags} id={id} movieTitle={movieTitle} />
